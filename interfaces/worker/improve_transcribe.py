...
def improve_transcribe(raw_transcript: str):
    client = OpenAI()
    ...
    response = client.beta.chat.completions.parse(
        ...
        messages=[
            {
                "role": "system",
                "content": "You will be helping me to create a dataset for a fine-tuned model.",
            },
