...
from infrastructure.openapi.conversation.llm_repository import OpenAIPlatformLLMRepository
...
llm_repository = OpenAIPlatformLLMRepository(api_key=os.getenv("OPENAI_API_KEY"), model=os.getenv("OPENAI_CONVERSATION_MODEL"))
